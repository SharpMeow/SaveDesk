...
Choose **Backup & share → Download shareable page**. Open the downloaded `.html` file in a browser to review it, then send that file to the person you want to share it with. It contains a searchable copy of all your saved posts and topics, without your reading progress. There is no login, installation, or server requirement for the reader.
